...
class Smalter(PipelineEnv):
    """Environment for training Smalter joystick policy in MJX."""

    def __init__(
        self,
        filename: str = 'walter/scene_smalter.xml',
        ...
        **kwargs,
        ...
        self._rear_body_idx = mujoco.mj_name2id(
            sys.mj_model, mujoco.mjtObj.mjOBJ_BODY.value, 'rearBody'
        )
